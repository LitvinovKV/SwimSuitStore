...
<section class="s-steps">
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<div>
					<a class="step tablink" onclick="openTab(event, 'Basket')" id="defaultOpen"><span class="number">1</span>Корзина товаров</a>
				</div>
			</div>
			<div class="col-md-4">
				<div>
					<a class="step tablink" onclick="openTab(event, 'Registration')"><span class="number">2</span>Оформление заказа</a>
				</div>
			</div>
			<div class="col-md-4">
				<div>
					<a class="step tablink" onclick="openTab(event, 'Check')"><span class="number">3</span>Проверка заказа</a>
				</div>
			</div>
		</div>
	</div>
	...
	<section class="s-parameters">
		<div class="container">
			<div class="row">
				<div class="col-md-2">
					<div class="p-item">
						<img src="/images/products_images/1.jpeg" alt="Product">
					</div>
				</div>
				<div class="col-md-2">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="result">
						...
						<a href="#" class="button">Обновить корзину</a>
					</div>
				</div>
				<div class="col-md-3">
					<div class="result">
						<p class="result-sum">2800 <span>руб</span></p>
						<a href="#" class="button registration">Оформление заказа</a>
					</div>
				</div>
			</div>
		</div>
...
<div id="Registration" class="tabcontent">
	...
	<section class="s-comment">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<textarea name="comment" class="comment" cols="119" rows="4" placeholder="Комментарий"></textarea>
				</div>
			</div>
		</div>
	</section>
	<section class="s-button">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<a href="#" class="button-reg">Оформление заказа</a>
				</div>
			</div>
		</div>
	</section>
...
<div id="Check" class="tabcontent">
	...
	<section class="s-button">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<a href="#" class="button-reg">Оформить заказ</a>
				</div>
			</div>
		</div>
	</section>
